---
created: '2026-08-29'
description: Run an evidence-led web quality audit covering performance, accessibility,
  SEO, best practices, and agentic browsing. Use when asked to "audit my site", "review
  web quality", "run lighthouse audit", "check page quality", or "optimize my website".
judge_score: null
name: web-quality-audit
origin: forge-996cce1c:web-quality-audit:1
signature: Vm4VmPpKf55OIVxC0TsTNcDOCWE8ajH6R8xtLbShiOeN+JtssgbR1qzxC11BYN12sYhe3Ji3VjIxGPp8vPfABw==
sources:
- id: src-1903cf
  url: https://github.com/addyosmani/web-quality-skills/blob/main/skills/web-quality-audit/SKILL.md
tags:
- web-quality
version: 1
visibility: private
