---
created: '2026-08-26'
description: "Before committing to a plan or launch, assume it already failed and\
  \ reason backward through concrete causes \u2014 convert failure paths into mitigations,\
  \ gates, and stop checks."
judge_score: null
name: thinking-pre-mortem
origin: forge-996cce1c:thinking-pre-mortem:1
signature: eUj6221l/bow8T4j1/hE5zJVPd+k7wLQEZfqqmel1qc139GZFhLbnIA0b0vusaqkQraFar6FMCaiaW61QDh1AA==
sources:
- id: src-a38aff
  url: https://github.com/tjboudreaux/cc-thinking-skills/blob/main/skills/thinking-pre-mortem/SKILL.md
tags:
- thinking
version: 1
visibility: private
...
- https://github.com/tjboudreaux/cc-thinking-skills/blob/main/skills/thinking-pre-mortem/SKILL.md
