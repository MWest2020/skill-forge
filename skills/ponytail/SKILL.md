...
description: 'Forces the laziest solution that actually works, simplest, shortest,
  ...
  intensity levels: lite, full (default), ultra. Use whenever the user says "ponytail",
  "be lazy", "lazy mode", "simplest solution", "minimal solution", "yagni", "do less",
  or "shortest path", and whenever they complain about over-engineering, bloat, boilerplate,
  or unnecessary dependencies.

  '
judge_score: null
name: ponytail
origin: forge-996cce1c:ponytail:1
