---
created: '2026-07-17'
description: This skill should be used when the user asks to "add a constraint", "design
  a constraint", "write a harness rule", "choose enforcement type", "promote a constraint",
  "configure a verification slot", or needs guidance on the Constraints section of
  HARNESS.md.
judge_score: null
name: constraint-design
origin: forge-996cce1c:constraint-design:1
signature: JX8DMTF30AfyKhlZmC9BlljvsQBFcJE4PqBPTLDVu43LuNllerNEVBIUvO1gnAmQjaoiLEhzJwE1lARZUS2VAQ==
sources:
- id: src-ccb685
...
- https://github.com/Habitat-Thinking/ai-literacy-superpowers/blob/main/ai-literacy-superpowers/skills/constraint-design/SKILL.md (Apache-2.0, Habitat-Thinking / Russ Miles)
