---
created: '2026-07-17'
description: "Use when the user wants to estimate or predict the cost, token usage,\
  \ or time of a task BEFORE it runs \u2014 \"how much will this feature cost to build\"\
  , \"estimate the tokens for this spec\", \"what will this slice cost\", \"predict\
  \ the agent-compute time before I commit\" \u2014 produces a token + time estimate\
  \ as a range with disclosed confidence, adding a dollar figure only when an observability/costs\
  \ snapshot grounds it. The prospective sibling of cost-tracking, which records actual\
  \ spend after the fact."
judge_score: null
name: cost-estimation
origin: forge-996cce1c:cost-estimation:1
signature: yCmAEZ/kQ73vxU80MRqJZ7j0CYggcmOf4paUgFvf61YTXTNQbE0jaFWFB/vQLWsEPv6WFZFis1/zegdL7fikDQ==
sources:
- id: src-7dbd43
...
- https://github.com/Habitat-Thinking/ai-literacy-superpowers/blob/main/ai-literacy-superpowers/skills/cost-estimation/SKILL.md (Apache-2.0, Habitat-Thinking / Russ Miles)
