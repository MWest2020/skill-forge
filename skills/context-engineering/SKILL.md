---
created: '2026-07-17'
description: This skill should be used when the user asks about "writing conventions",
  "codebase context", "HARNESS.md context section", "convention documentation", "how
  to write enforceable rules", or needs guidance on the Context section of HARNESS.md.
judge_score: null
name: context-engineering
origin: forge-996cce1c:context-engineering:1
signature: c2kmBIw9mqN10EgO684JR4i7q2PT9byIce+m/o6tC3eyvS+A3vGKBiFfpdbSs+qwkE9UW24nXwvjB9LYoo1LAQ==
sources:
- id: src-3fbd44
...
- https://github.com/Habitat-Thinking/ai-literacy-superpowers/blob/main/ai-literacy-superpowers/skills/context-engineering/SKILL.md (Apache-2.0, Habitat-Thinking / Russ Miles)
