---
created: '2026-08-26'
description: When unsure which thinking skill fits, map domain and problem type, then
  return NONE or one primary skill by default (at most three complementary).
judge_score: null
name: thinking-model-router
origin: forge-996cce1c:thinking-model-router:1
signature: a+GeSEEJoij4pneCvUnLsfoAk0YX4awonYrTXjjqE7hmISwDZ91E7fphmxIYaXAUMWCucRLC+NRBnW3nwhXoBQ==
sources:
- id: src-b230ab
  url: https://github.com/tjboudreaux/cc-thinking-skills/blob/main/skills/thinking-model-router/SKILL.md
tags:
- thinking
version: 1
visibility: private
...
- https://github.com/tjboudreaux/cc-thinking-skills/blob/main/skills/thinking-model-router/SKILL.md
