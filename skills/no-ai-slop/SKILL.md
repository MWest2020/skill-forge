...
judge_score: null
name: no-ai-slop
origin: forge-996cce1c:no-ai-slop:1
signature: ifFlzxpdfIHzz7FKzakedhRtFD3bGCtKdQz+c3Zz2miO+7g0iX+LXdTZnLNgR+W5pexpGSnAbUB+pYVFocSdDQ==
sources:
- id: src-73f87f
  url: https://github.com/petergyang/no-ai-slop/blob/main/SKILL.md
tags:
- writing
version: 1
visibility: private
