---
created: '2026-08-29'
description: Optimize Core Web Vitals (LCP, INP, CLS) for better page experience using
  field and lab evidence. Use when asked to "improve Core Web Vitals", "fix LCP",
  "reduce CLS", "optimize INP", "page experience optimization", or "fix layout shifts".
judge_score: null
name: core-web-vitals
origin: forge-996cce1c:core-web-vitals:1
signature: od5/l+rgclBv2vojnoyVDmnT8iue4hvycLQpBTsFsCMaW5lbr3HUgdtJzETsZEAcvSCCLXRNwrBD3e1N+RvlDw==
sources:
- id: src-731aa7
  url: https://github.com/addyosmani/web-quality-skills/blob/main/skills/core-web-vitals/SKILL.md
tags:
- web-quality
version: 1
visibility: private
