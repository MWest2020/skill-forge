---
created: '2026-07-17'
description: "Use when acting as the adversarial spec reviewer \u2014 raises steel-manned\
  \ objections across six categories before plan approval, requires evidence per objection,\
  \ and discloses what was not challenged"
judge_score: null
name: advocatus-diaboli
origin: forge-996cce1c:advocatus-diaboli:1
signature: 90Skrm3CxfXEALMUJ1gLM6erD/g+ZEClARtHOaqYQIEH7ABjGEpw1bAWJE/Twh0WJ5CgA/T53LfEAW3RE/z3AQ==
sources:
- id: src-1122dc
...
- https://github.com/Habitat-Thinking/ai-literacy-superpowers/blob/main/ai-literacy-superpowers/skills/advocatus-diaboli/SKILL.md (Apache-2.0, Habitat-Thinking / Russ Miles)
